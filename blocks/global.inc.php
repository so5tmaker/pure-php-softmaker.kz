...
function get_all_cat_rows() {
    ...
    foreach($cat_array as $k => $v) {
        ...
        if ($v[id]==2){ // PHP
            $cat_rows .= "<tr><td><p><span class=nolink onclick=\"GoTo('_mchost.ru/?referer=1552694667','')\">
                    <span>
                    &#160;&#160;&#10149; PHP хостинг сайтов Макхост
                    </span>
            </span></p></td></tr>"; 
        } 
        if ($v[id]==5){ // 1с
            $cat_rows .= "<tr><td><p><span class=nolink onclick=\"GoTo('_shop.work-1c.ru/Podpsnie/Prog_1c?utm_medium=affiliate&utm_source=softmaker','')\">
                    <span>
                    &#160;&#160;&#10149;Бесплатные видеоуроки по 1С
                    </span>
            </span></p></td></tr>";  
        ...
        if ($v[id]==14){ // СКД
            $cat_rows .= "<tr><td><p><span class=nolink onclick=\"GoTo('_shop.work-1c.ru/Komponovka/p_komponovka?utm_medium=affiliate&utm_source=softmaker','')\">
                    <span>
                    &#160;&#160;&#10149;Бесплатные видеоуроки по СКД (компоновка данных)
                    </span>
            </span></p></td></tr>"; 
        } 
        if ($v[id]==15){ // Обмен
            $cat_rows .= "<tr><td><p><span class=nolink onclick=\"GoTo('_shop.work-1c.ru/convempty/NewPotok?utm_medium=affiliate&utm_source=softmaker','')\">
                    <span>
                    &#160;&#160;&#10149;Бесплатные видеоуроки по технологии \"Конвертация данных\"
                    </span>
            </span></p></td></tr>"; 
        } 
        if ($v[id]==16){ // Запросы
            $cat_rows .= "<tr><td><p><span class=nolink onclick=\"GoTo('_shop.work-1c.ru/aff/free/100341/softmaker/','')\">
                    <span>
                    &#160;&#160;&#10149;Бесплатные видеоуроки по языку запросов 1С
                    </span>
            </span></p></td></tr>"; 
        } 
        if ($v[id]==18){ // Разное
            $cat_rows .= "<tr><td><p><span class=nolink onclick=\"GoTo('_hosting.reg.ru/?rid=1537108','')\">
                    <span>
                    &#160;&#160;&#10149;Отличный хостинг от REG.RU
                    </span>
            </span></p></td></tr>";
        } 
        if ($v[id]==28){ // MySQL
            $cat_rows .= "<tr><td><p><span class=nolink onclick=\"GoTo('_my.just-hosting.ru/mancgi/partnerprogram?partner=17475&project=1','s')\">
                    <span>
                    &#160;&#160;&#10149;MySQL хостинг от Just Hosting
                    </span>
            </span></p></td></tr>";
        }
        if ($v[id]==30){ // Freelance
            $cat_rows .= "<tr><td><p><span class=nolink onclick=\"GoTo('_freelancer.com.ru/affiliates/softmaker','s')\">
                    <span>
                    &#160;&#160;&#10149;Биржа труда Freelancer
                    </span>
            </span></p></td></tr>";
        }
    }
